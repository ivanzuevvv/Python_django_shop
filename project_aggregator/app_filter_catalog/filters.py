...
class ProductFilter(PropertyFilterSet):
    ...
    name = django_filters.CharFilter(
        field_name='name', lookup_expr='icontains', widget=forms.TextInput(
            attrs={'class': 'form-input form-input_full', 'placeholder': 'Название'}))
    manufacturer = django_filters.CharFilter(
        field_name='manufacturer', lookup_expr='icontains', widget=forms.TextInput(
            attrs={'class': 'form-input form-input_full', 'placeholder': 'Производитель'}))
    ...
    price = django_filters.CharFilter(
        method='price_range', field_name='price', lookup_expr='range', widget=forms.TextInput(
            attrs={
                'class': 'range-line',
                'data-type': 'double',
